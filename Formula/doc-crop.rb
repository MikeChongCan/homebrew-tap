class DocCrop < Formula
  ...
  homepage "https://github.com/imWildCat/doc-preprocessing-cli"
  license "MIT"

  # When a GitHub release exists, use the pre-built universal binary:
  # url "https://github.com/imWildCat/doc-preprocessing-cli/releases/download/v#{version}/doc-crop-macos-universal.tar.gz"
